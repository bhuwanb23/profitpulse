"""
Tests for RandomForestProfitabilityModel
"""
...
try:
    from src.models.profitability_predictor.random_forest_model import RandomForestProfitabilityModel, train_random_forest_profitability_model, predict_with_random_forest_model
    SKLEARN_AVAILABLE = True
except ImportError:
    SKLEARN_AVAILABLE = False
    print("Skipping Random Forest tests - scikit-learn not available")
...
def test_random_forest_model_initialization():
    """Test RandomForestProfitabilityModel initialization"""
...
def test_model_save_load():
    ...
    try:
        ...
        # Load model
        loaded_model = RandomForestProfitabilityModel(temp_file.name)
...
def test_convenience_functions():
    ...
    try:
        model, results = train_random_forest_profitability_model(
            train_data, 
            'profit_margin', 
            val_data,
        ...
        predictions = predict_with_random_forest_model(temp_file.name, val_data.head(5))
        assert isinstance(predictions, np.ndarray)
